...
function CellLeaderSubmitPrayerRequestPage({ user, onBack }) {
  const { t } = useLanguage();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await addDoc(collection(db, 'prayer_requests'), {
        personName,
        description,
        submittedBy: user?.name || user?.email || 'Leader',
    ...
    <Box>
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            {loading ? 'Submitting...' : (t('gen.submit') || 'Submit')}
          </Button>
        </form>
      </Paper>
    </Box>
...
export default CellLeaderSubmitPrayerRequestPage;
